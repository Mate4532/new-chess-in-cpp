...
int Searcher::quiescence(int alpha, int beta, int ply) {
    ...
    int standPat = currentSettings.worseEvaluationEnabled ? WorseEvaluation::Evaluation::EvaluatePos(board) : Evaluation::Evaluation::EvaluatePos(board, ply, nnue_state);
