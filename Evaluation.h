...
public:
    ...
    static int KingPawnShield(const Board& board, Color color, float enemyEndgameT, float enemyPieceSquareScore);
    static int MopUpEval(const Board& board, Color winner, float endgameT);
    static uint64_t GetKingZone(const Board& board, Square kingSq);
